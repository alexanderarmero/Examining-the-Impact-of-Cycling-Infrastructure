...
public class InHurryRuleFollowingAgentBehaviour extends TickerBehaviour implements CommunicationModels {
    ...
    // Constructor
    public InHurryRuleFollowingAgentBehaviour(SumoTraciConnection conn, String agentType, double silent, Agent agent, long interval) {
                ...
                switch (agentType) {
                    case "vehicle":
                        if (vType.equals("veh__passenger")) {
                             conn.do_job_set(Vehicle.setParameter(vehicleId, "lcCooperative", "0.6"));
                             conn.do_job_set(Vehicle.setParameter(vehicleId, "lcSpeedGain", "0.8"));
                             conn.do_job_set(Vehicle.setParameter(vehicleId, "lcKeepRight", "0.8"));
                            System.out.println("Connected to car: " + vehicleId);

                            // Define values for InHurryRuleFollowing cars
                            speed = 16.7; // meters per second (60 km/h)
                            acceleration = 3.2; // meters per second squared
                            gapAcceptance = 2.2; // meters
                            laneChanging = 1.0; // some value representing lane changing behavior
                            ...
                            // Define values for InHurryRuleFollowing motorcycles
                            ...
                            // Define values for InHurryRuleFollowing buses
                            speed = 13.9; // meters per second (50 km/h)
                            acceleration = 1.8; // meters per second squared
                            gapAcceptance = 2.5; // meters
                            laneChanging = 0.9; // some value representing lane changing behavior
                    ...
                    case "cyclist":
                        if (vType.equals("cyc__bicycle")) {
                            ...
                            // Define values for InHurryRuleFollowing cyclists
                            speed = 6.1; // meters per second (22 km/h)
                            acceleration = 1.7; // meters per second squared
                            gapAcceptance = 1.5; // meters
                            laneChanging = 0.6; // some value representing lane changing behavior
