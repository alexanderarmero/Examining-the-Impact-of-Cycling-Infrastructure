...
public class InHurryRuleBreakingAgentBehaviour extends TickerBehaviour implements CommunicationModels {
    ...
    // Constructor
    public InHurryRuleBreakingAgentBehaviour(SumoTraciConnection conn, String agentType, double silent, Agent agent, long interval) {
                ...
                switch (agentType) {
                    case "vehicle":
                        if (vType.equals("veh__passenger")) {
                          ...
                          conn.do_job_set(Vehicle.setParameter(vehicleId, "lcKeepRight", "0.1"));
                            ...
                            // Define values for InHurryRuleBreaking cars
                            speed = 16.7; // meters per second (60 km/h)
                            acceleration = 3.2; // meters per second squared
                            gapAcceptance = 1.8; // meters
                            laneChanging = 1.5; // some value representing lane changing behavior
                          ...
                          conn.do_job_set(Vehicle.setParameter(vehicleId, "lcKeepRight", "0.1"));
                            ...
                            // Define values for InHurryRuleBreaking motorcycles
                            speed = 19.4; // meters per second (70 km/h)
                            acceleration = 3.8; // meters per second squared
                            gapAcceptance = 1.3; // meters
                            laneChanging = 1.7; // some value representing lane changing behavior
                          ...
                          conn.do_job_set(Vehicle.setParameter(vehicleId, "lcKeepRight", "0.1"));
                            ...
                            // Define values for InHurryRuleBreaking buses
                            speed = 13.9; // meters per second (50 km/h)
                            acceleration = 1.8; // meters per second squared
                            gapAcceptance = 2.0; // meters
                            laneChanging = 1.2; // some value representing lane changing behavior
                    ...
                    case "cyclist":
                        if (vType.equals("cyc__bicycle")) {
                         ...
                         conn.do_job_set(Vehicle.setParameter(vehicleId, "laneChangeModel.lcCooperative", "0.2"));
                        conn.do_job_set(Vehicle.setParameter(vehicleId, "laneChangeModel.lcSpeedGain", "1.1"));
                        conn.do_job_set(Vehicle.setParameter(vehicleId, "laneChangeModel.lcKeepRight", "0.1"));


                            // Define values for InHurryRuleBreaking cyclists
                            speed = 6.1; // meters per second (22 km/h)
                            acceleration = 1.7; // meters per second squared
                            gapAcceptance = 1.2; // meters
                            laneChanging = 0.8; // some value representing lane changing behavior
    ...
    double messageProbability = random.nextDouble();
        ...
        if (messageProbability < 0.5) {
            ...
            System.out.println("[" + agentType + " " + vehicleId + "] Sending message to nearby agents");
